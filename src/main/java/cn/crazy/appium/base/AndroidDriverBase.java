...
public class AndroidDriverBase extends AndroidDriver{
	 ...
	 * @throws Exception 
	 */
	public AndroidDriverBase(Boolean isInstallApp,String server,String port,String udid,String input) throws Exception{
		super(new URL(server+":"+port+"/wd/hub"),new CrazyCapabilities().initCaps(isInstallApp,udid));
		this.input=input;
		this.udid=udid;
	}
