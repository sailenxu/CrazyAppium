...
public class DriverInit {
	...
	public AndroidDriverBase driverInit(boolean isInstallApp,String udid,String port) throws Exception{
			...
			driver=new AndroidDriverBase(isInstallApp,server, port, udid, input);
