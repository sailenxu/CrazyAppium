...
public class Study extends DriverInit{
	...
	public void login() throws Exception{
		driver.findElement(By.name("登录或注册")).click();
...
//		driver.swipeUntilElement(By.name("现实世界有哪些 Bug？"), "up", 1000, 30).click();
...
//		}
		...
		AndroidElement element=driver.findElement(By.name("知乎"));
